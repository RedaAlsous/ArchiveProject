...
namespace Archive.Infrastructure.Migrations
{
    ...
    [Migration("20240710222014_loggingToDb")]
    partial class loggingToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Archive.Domain.Entites.CustomError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Archive.Domain.Entites.SharedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SharedItemUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("SharedItemUserId");

                    b.ToTable("SharedItems");
                });

            modelBuilder.Entity("Archive.Domain.Entites.User", b =>
                {
            ...
            modelBuilder.Entity("Archive.Domain.Entites.Efile", b =>
                {
                    ...
                    b.HasOne("Archive.Domain.Entites.SharedItem", null)
            ...
            modelBuilder.Entity("Archive.Domain.Entites.SharedItem", b =>
                {
                    b.HasOne("Archive.Domain.Entites.User", "User")
                        .WithMany("SharedItems")
                        .HasForeignKey("SharedItemUserId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Archive.Domain.Entites.User", null)
                        .WithMany()
